...
internal static class Program
{
    ...
    private const string DefaultGamePath = @"C:\Program Files (x86)\Steam\steamapps\common\grid 2";
    ...
    private static string DetectGamePath()
    {
        ...
        {
            candidates.Add($@"{drive}:\SteamLibrary\steamapps\common\grid 2");
            candidates.Add($@"{drive}:\Program Files (x86)\Steam\steamapps\common\GRID 2");
            candidates.Add($@"{drive}:\Program Files\Steam\steamapps\common\GRID 2");
        }
...
internal sealed class InstallerForm : Form
{
    ...
    {
        Text = "EgoNet Revival - GRID 2 Installer";
        ...
        {
            Text = "Select the GRID 2 installation folder, then install the RaceNet restoration mod.",
            AutoSize = true,
    ...
    private void BrowseGameFolder()
    {
        ...
        {
            Description = "Select your GRID 2 installation folder",
    ...
    private async Task InstallAsync()
    {
        ...
        try
        {
            ...
            MessageBox.Show(
                "Done. Open GRID 2 and enter RaceNet / Rivals.",
                "EgoNet Revival",
                MessageBoxButtons.OK,
...
internal sealed class Grid2Installer(string server, string gamePath, Action<string> log)
{
    ...
    private void ValidateGameFolder()
    {
        ...
        {
            throw new FileNotFoundException("GRID 2 executables were not found in: " + gamePath);
        }
    }
    ...
    private void CloseGameIfRunning()
    {
        ...
        log("Closing GRID 2 before patching...");
    ...
    private void UpdateHostsFile()
    {
        ...
        foreach (var line in File.ReadAllLines(hostsPath))
        {
            ...
            if (trimmed.Equals("# EgoNet Revival GRID 2", StringComparison.OrdinalIgnoreCase))
            {
                continue;
            }
        ...
        cleanHosts.Add("");
        cleanHosts.Add("# EgoNet Revival GRID 2");
